...
const file_api_proto_dio_proto_rawDesc = "" +
	"\n" +
	"\x13api/proto/dio.proto\x12\x03dio\"`\n" +
	...
	"\n" +
	"latency_ms\x18\x02 \x01(\x02R\tlatencyMs2M\n" +
	"\fOrchestrator\x12=\n" +
	"\x0eRegisterWorker\x12\x14.dio.RegisterRequest\x1a\x15.dio.RegisterResponse2K\n" +
	"\x0fInferenceWorker\x128\n" +
	"\aPredict\x12\x15.dio.InferenceRequest\x1a\x16.dio.InferenceResponseB\x1fZ\x1dgithub.com/nisaral/dio/pkg/pbb\x06proto3"
...
var file_api_proto_dio_proto_depIdxs = []int32{
	...
	2, // 1: dio.InferenceWorker.Predict:input_type -> dio.InferenceRequest
	1, // 2: dio.Orchestrator.RegisterWorker:output_type -> dio.RegisterResponse
	3, // 3: dio.InferenceWorker.Predict:output_type -> dio.InferenceResponse
