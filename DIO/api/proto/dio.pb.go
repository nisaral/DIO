...
var file_api_proto_dio_proto_depIdxs = []int32{
	...
	2, // 3: dio.InferenceWorker.Predict:input_type -> dio.InferenceRequest
	4, // 4: dio.InferenceWorker.CheckHealth:input_type -> google.protobuf.Empty
	1, // 5: dio.Orchestrator.RegisterWorker:output_type -> dio.RegisterResponse
	3, // 6: dio.Orchestrator.Infer:output_type -> dio.InferenceResponse
	3, // 7: dio.Orchestrator.ExecuteInference:output_type -> dio.InferenceResponse
	3, // 8: dio.InferenceWorker.Predict:output_type -> dio.InferenceResponse
	4, // 9: dio.InferenceWorker.CheckHealth:output_type -> google.protobuf.Empty
